...
var openMenu = function openMenu() {
  ...
  for (var i = 0; i < sidebarLinks.length; i++) {
    TweenMax.to(sidebarLinks[i], 0.4, {
      opacity: 1,
      y: 0,
      delay: delay
    });
...
var closeMenu = function closeMenu() {
  var delay = 0.1;
  var lenght = sidebarLinks.length;
...
window.addEventListener('scroll', checkHeader); // sidebar functionality on mobile devices

var mobileBurger = document.querySelector('.mobileNavigation__burger');

if (mobileBurger) {
  mobileBurger.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _animations.openMenu)();
  });
}
...
var mobileGetStarted = document.querySelector("#mobileGetStarted"); // footer navigation

var footerAbout = document.getElementById('footerAbout');
var footerFeatures = document.getElementById('footerFeatures');
var footerBenefits = document.getElementById('footerBenefits');
var footerPricing = document.getElementById('footerPricing');
...
footerBenefits.addEventListener('click', function (e) {
  e.preventDefault();
  (0, _jump.default)('.benefits');
});
footerFeatures.addEventListener('click', function (e) {
  e.preventDefault();
  (0, _jump.default)('.howItWorks');
}); // mobile navigation
